...
1. Go to Test Account section from the left sidebar.
   ...
   ![Hubspot Developer Portal](https://raw.githubusercontent.com/Thakshaka/module-ballerinax-hubspot.crm.engagements.email/refs/heads/pr3/docs/resources/test_acc_1.png) 

2. Click Create developer test account.

   ![Hubspot Developer Test Account](https://raw.githubusercontent.com/Thakshaka/module-ballerinax-hubspot.crm.engagements.email/refs/heads/pr3/docs/resources/test_acc_2.png)

3. In the dialogue box, give a name to your test account and click create.

   ![Hubspot Developer Test Account](https://raw.githubusercontent.com/Thakshaka/module-ballerinax-hubspot.crm.engagements.email/refs/heads/pr3/docs/resources/test_acc_3.png)

### Step 3: Create a HubSpot App under your account.

1. In your developer account, navigate to the "Apps" section. Click on "Create App"

   ![Hubspot Create App](https://raw.githubusercontent.com/Thakshaka/module-ballerinax-hubspot.crm.engagements.email/refs/heads/pr3/docs/resources/create_app_1.png)
...
1. Move to the Auth Tab. (Second tab next to App Info)
   ...
   ![Hubspot Developer Config Auth](https://raw.githubusercontent.com/Thakshaka/module-ballerinax-hubspot.crm.engagements.email/refs/heads/pr3/docs/resources/create_app_2.png )
...
2. In the Scopes section, add the following scope for your app using the "Add new scope" button.
   ...
   * `sales-email-read`
   ...
   ![Hubspot Developer App Add Scopes](https://raw.githubusercontent.com/Thakshaka/module-ballerinax-hubspot.crm.engagements.email/refs/heads/pr3/docs/resources/scopes.png )

4. Add your Redirect URI in the relevant section. You can also use `localhost` addresses for local development purposes. Click Create App.

   ![Hubspot Create Developer App](https://raw.githubusercontent.com/Thakshaka/module-ballerinax-hubspot.crm.engagements.email/refs/heads/pr3/docs/resources/create_app_final.png )

### Step 5: Get your Client ID and Client Secret

- Navigate to the Auth section of your app. Make sure to save the provided Client ID and Client Secret.

   ![Hubspot Get Credentials](https://raw.githubusercontent.com/Thakshaka/module-ballerinax-hubspot.crm.engagements.email/refs/heads/pr3/docs/resources/get_credentials.png )
...
2. Paste it in the browser and select your developer test account to install the app when prompted.
   ...
   ![Hubspot Get Auth Code](https://raw.githubusercontent.com/Thakshaka/module-ballerinax-hubspot.crm.engagements.email/refs/heads/pr3/docs/resources/install_app.png)
...
public function main() returns error? {
    hsceemail:BatchResponseSimplePublicObject|BatchResponseSimplePublicObjectWithErrors response = check hubspot->/batch/read.post({
